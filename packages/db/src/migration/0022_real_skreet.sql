...
INSERT INTO `__new_repository`("id", "path", "description", "provider", "webhook_secret", "language", "github_installation_id", "github_repository_id", "git_provider_access_id", "git_provider_repository_id", "review_on_merge_request_open", "inline_review", "reply_to_merge_request_comment", "deep_research_on_merge_request", "comment_on_issue_open", "reply_to_issue_comment", "model_id", "created_at", "updated_at") SELECT "id", COALESCE("github_repository_path", "name"), "name", "provider", "webhook_secret", "language", "github_installation_id", "github_repository_id", "git_provider_access_id", "git_provider_repository_id", "review_on_merge_request_open", "inline_review", "reply_to_merge_request_comment", "deep_research_on_merge_request", "comment_on_issue_open", "reply_to_issue_comment", "model_id", "created_at", "updated_at" FROM `repository`;--> statement-breakpoint
