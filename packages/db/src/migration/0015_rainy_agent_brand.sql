CREATE TABLE `github_installation` (
	...
	FOREIGN KEY (`app_id`) REFERENCES `github_app`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE UNIQUE INDEX `github_installation_installationId_unique` ON `github_installation` (`installation_id`);--> statement-breakpoint
