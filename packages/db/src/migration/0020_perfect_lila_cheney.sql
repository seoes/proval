...
INSERT INTO `__new_repository`("id", "name", "provider", "webhook_secret", "bot_username", "language", "github_installation_id", "github_repository_path", "github_repository_id", "git_provider_access_id", "git_provider_repository_id", "review_on_merge_request_open", "inline_review", "reply_to_merge_request_comment", "deep_research_on_merge_request", "comment_on_issue_open", "reply_to_issue_comment", "model_id", "created_at", "updated_at") SELECT "id", "name", "provider", CASE WHEN "webhook_secret" IS NULL OR trim("webhook_secret") = '' THEN lower(hex(randomblob(32))) ELSE "webhook_secret" END, "bot_username", "language", "github_installation_id", "github_repository_path", "github_repository_id", "git_provider_access_id", "git_provider_repository_id", "review_on_merge_request_open", "inline_review", "reply_to_merge_request_comment", "deep_research_on_merge_request", "comment_on_issue_open", "reply_to_issue_comment", "model_id", "created_at", "updated_at" FROM `repository`;--> statement-breakpoint
