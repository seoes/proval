...
INSERT INTO `__new_model`("id", "provider", "name", "label", "base_url", "api_key", "created_at", "updated_at") SELECT "id", "provider", "model", "model", "base_url", "api_key", "created_at", "updated_at" FROM `llm_config`;--> statement-breakpoint
...
INSERT INTO `__new_repository`("id", "name", "provider", "base_url", "api_token", "webhook_secret", "bot_username", "review_mode", "reply_mode", "auto_assign", "language", "gitlab_repository_id", "model_id", "created_at", "updated_at") SELECT "id", "name", "provider", "base_url", "api_token", "webhook_secret", "bot_username", "review_mode", "reply_mode", "auto_assign", "language", "gitlab_repository_id", "llm_id", "created_at", "updated_at" FROM `repository`;--> statement-breakpoint
