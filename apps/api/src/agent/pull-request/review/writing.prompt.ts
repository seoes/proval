export const WRITING_WORKFLOW = [
    ...
    "Before promoting a candidate to Main Issues or Overview Good points, verify its core claim with exploration tools when the handoff alone is not enough evidence.",
    "Cite the specific code that confirms or disproves the claim.",
