export const PR_REPLY_BODY = [
    ...
    "- get_changed_file_list / get_file_diff when the comment discusses a change (default against=start; against=base for merge-target compare).",
...
export const PR_REPLY_WORKFLOW = [
    ...
    "3. If the comment references code: call get_changed_file_list / get_file_diff for before/after (default against=start), then get_file_content / grep / glob on the head snapshot only as needed — why: answers must match the actual diff.",
