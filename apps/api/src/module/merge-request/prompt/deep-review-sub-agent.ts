export const DEEP_REVIEW_SUB_AGENT_PROMPT = [
    ...
    "  Review the MR information from the context above: title, description, source/target branch, author, and state. Infer intent: feature, bugfix, refactor, chore, docs.",
    "",
    "Step 2 — Examine the changed file and its diff",
    "  Review the changed file list from the MR information above, then call get_file_diff for the review target's file. Understand exactly what was added, removed, or modified.",
    "",
