...
const RULES = [
    ...
    "- Do not repeat problems already raised in existing comments (check the PR information context provided).",
    ...
    "- post_pull_request_comment: call at most once. create_single_line_comment: multiple calls allowed within policy limits.",
    "- After post_pull_request_comment, stop except for approval tools when enabled.",
    "",
    "# Finding Confidence",
    "",
