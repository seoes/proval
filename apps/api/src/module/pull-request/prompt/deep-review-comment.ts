...
const WORKFLOW = [
    ...
    "Your job is to post their findings as comments on the pull request.",
    "",
    ...
    "  Call get_pull_request_version once to get baseSha, startSha, headSha for inline comment positioning.",
    "",
