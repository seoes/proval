...
export const COMMENT_ON_OPEN_PROMPT = [
    ...
    "3. Search related issues and merge requests with search_issue_list and search_merge_request_list using the title, error text, and key nouns from the issue.",
    ...
    "- If you found related issues or merge requests, include only the strongest few matches and explain the overlap briefly.",
