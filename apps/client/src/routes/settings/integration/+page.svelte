<script lang="ts">
    ...
    import { PlugIcon, TrashIcon } from 'phosphor-svelte';
    ...
    async function getInstallUrl() {
        ...
        // Open window immediately in response to user click to avoid popup blocker
...
<DefaultLayout title="Integration">
    <div class="space-y-6">
            ...
            {#if data.app}
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        >
                            <PlugIcon class="size-5 text-neutral-600" />
                        </div>
                        <div>
        ...
        {#if data.app}
            <Card title="Installations" border>
